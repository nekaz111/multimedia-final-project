...
# basic optical flow
# apparently this could maybe be used in combination with frame differencing to figoure out what is moving relative to forward car motion but I was not able to figure out how to do this in time
# not considered part of the paper since I was still trying to figure out ho wthis works

import numpy as np
import cv2 as cv

cap = cv.VideoCapture('static_camera.mp4')
